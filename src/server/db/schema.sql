...
CREATE TABLE platform_credentials (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  org_id UUID REFERENCES organizations(id) ON DELETE CASCADE NOT NULL,
  platform TEXT NOT NULL CHECK (platform IN ('instagram', 'youtube', 'linkedin', 'google_drive', 'email_smtp', 'llm_provider', 'llm_openrouter', 'llm_anthropic', 'llm_openai', 'llm_google', 'facebook', 'tiktok', 'twitter', 'snapchat')),
...
CREATE TABLE social_accounts (
  ...
  platform TEXT CHECK (platform IN ('instagram', 'youtube', 'linkedin', 'facebook', 'tiktok', 'twitter', 'snapchat')) NOT NULL,
...
CREATE TABLE media_assets (
  ...
  tagged_platform TEXT CHECK (tagged_platform IN ('instagram', 'youtube', 'linkedin', 'facebook', 'tiktok', 'twitter', 'snapchat')),
...
-- ─── Platform Comments (synced from social platforms) ───
CREATE TABLE platform_comments (
  ...
  social_account_id UUID REFERENCES social_accounts(id) ON DELETE SET NULL,
  platform TEXT NOT NULL CHECK (platform IN ('instagram', 'youtube', 'linkedin', 'facebook', 'tiktok', 'twitter', 'snapchat')),
  platform_comment_id TEXT NOT NULL,
  platform_post_id TEXT,
  platform_parent_comment_id TEXT,
...
ALTER TABLE comment_replies ADD CONSTRAINT comment_replies_template_id_fkey FOREIGN KEY (template_id) REFERENCES reply_templates(id) ON DELETE SET NULL;
